class ContextAwareApp {
    ...
    initialize() {
        ...
        this.addMessageToChat(
            "Welcome! Here's how to get started:\n1. Paste your context into the 'Knowledge Base' on the left.\n2. Click 'Index Context' to make it searchable.\n3. Ask me questions about the content you provided.",
            'ai'
        );
        this.updateUI();
    }
    ...
    updateUI() {
        ...
        this.elements.indexContextBtn.disabled = this.state.isIndexing || this.elements.contextInput.value.trim().length < 10;
        ...
        messageDiv.innerHTML = `
            ...
            <div class="flex-1">
                <div class="bg-slate-800/50 rounded-xl p-4 border border-slate-600/30">
                    <p class="text-slate-200 leading-relaxed">${formattedMessage}</p>
                </div>
